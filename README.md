...
> 🎮 **Click below for the full 3D interactive version** — hover each pill for a lift effect, explore all tools with color-coded categories

[![Open 3D Tech Stack →](https://img.shields.io/badge/🧊%20Open%20Interactive%20Tech%20Stack%20(3D%20Hover%20Effects)-7C3AED?style=for-the-badge&logoColor=white)](https://shyam-medh.github.io/shyam-medh/tech-stack-3d.html)
...
<!-- ════════════════════════════════════════════════════════════════
     3D CONTRIBUTION GRAPH (GitHub Actions auto-generated)
════════════════════════════════════════════════════════════════ -->
...
> 🎮 **Click below for the 3D interactive version** — hover cells to see contribution counts, animated cell-by-cell reveal on load

[![Open 3D Activity Graph →](https://img.shields.io/badge/📊%20Open%20Interactive%20Activity%20Graph%20(3D%20Heatmap)-7C3AED?style=for-the-badge&logoColor=white)](https://shyam-medh.github.io/shyam-medh/activity-graph-3d.html)
...
| 🔍 **3× faster** retrieval | Multi-criteria due-task filter **(7+ filters)** using AJAX over manual workflow |
...
> 🎮 **Click below for the 3D interactive version** — tilt-on-hover cards with shine sweep effect

[![Open 3D Certifications →](https://img.shields.io/badge/🏅%20Open%20Interactive%20Certifications%20(3D%20Flip%20Cards)-7C3AED?style=for-the-badge&logoColor=white)](https://shyam-medh.github.io/shyam-medh/tech-stack-3d.html#certs)
...
<details>
<summary>⚙️ <b>Setup Guide — Activate All Live Features</b></summary>
...
### Step 2 — Commit all files to repo root
```
shyam-medh/
├── README.md
├── tech-stack-3d.html          ← 3D tech stack + certifications page
├── activity-graph-3d.html      ← 3D contribution heatmap page
└── .github/
    └── workflows/
        ├── 3d-contrib.yml      ← generates profile-3d-contrib/ daily
        └── snake.yml           ← generates snake SVG to output branch
```

### Step 3 — Enable GitHub Pages
Go to **Settings → Pages → Source: Deploy from branch → main → / (root)** → Save.

Your 3D pages will be live at:
- `https://shyam-medh.github.io/shyam-medh/tech-stack-3d.html`
- `https://shyam-medh.github.io/shyam-medh/activity-graph-3d.html`

### Step 4 — Run Workflows (first time)
Go to **Actions tab** → run `GitHub-Profile-3D-Contrib` → run `Generate Snake Animation`

### Step 5 — After workflows run ✅
- **3D Contrib graph** → saved to `./profile-3d-contrib/profile-night-rainbow.svg` → auto-shown in README
- **Snake animation** → pushed to `output` branch → auto-shown in README
- **3D Tech Stack / Activity / Certs** → live on GitHub Pages → linked via badges in README

All features auto-refresh every 24 hours. 🎉
