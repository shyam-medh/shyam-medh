...
[![HackerRank](https://img.shields.io/badge/HackerRank-00EA64?style=for-the-badge&logo=hackerrank&logoColor=black)](https://www.hackerrank.com/baranwal07shyam)
[![Codolio](https://img.shields.io/badge/Codolio-7C3AED?style=for-the-badge&logo=codeforces&logoColor=white)](https://codolio.com/profile/shyambaranwal)
...
class ShyamBaranwal:
    ...
    def __init__(self):
        ...
        self.company  = "Zapuza Technology (Remote)"
        self.mobile   = "+91-7009811512"
        self.email    = "baranwal07shyam@gmail.com"
...
| ⚡ Impact | 🚀 What I Built |
|:---|:---|
| 🔽 **50% Faster Lookup** | Django invoice page merging **3+ data sources** into one unified view |
| 📈 **+25% Engagement** | Real-time push notifications via **WebPusher** across **100+ users** |
...
```text
  GitHub Push  →  GitHub Actions  →  Jenkins Master-Agent  →  Docker Build & Compose
       →  .env Secret Injection  →  Django manage.py Tests ✅  →  AWS EC2 Deploy 🚀
```

| ✅ Achievement | 📊 Result |
|:---|:---|
| Deployment time reduced | **75% faster** |
| Config errors eliminated | **95% reduction** |
